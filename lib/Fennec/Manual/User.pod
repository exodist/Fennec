...
do not use Test::Builder. This was done in order to provide bette diagnostics
...
Test::Builder based tools instead of its own implementations, See CHAPTER 7.3 -
MORE ON TEST::BUILDER.
...
=head2 CHAPTER 7.3 - MORE ON TEST::BUILDER
