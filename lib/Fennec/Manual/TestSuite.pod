...
B<NOTE> I<Unlike the standalone tests, you do not end the test file with finish().>
...
The following will load L<Fennec::Assert::TBCore> asset libraries instead of
