...
implement it your own way easily.
...
imeplement the add_item() method which takes a workflow or testset. Testsets
...
the class frin which build_with() was called. The exported method will take a
single codeblock as an argument. After being build the instance will be added
