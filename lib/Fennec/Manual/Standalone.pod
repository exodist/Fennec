...
You should also read L<Fennec::Manual::Tests> for more information.
...
I appologise for this boilderplate, but it is safer than an END block.
...
L<Fennec::Manual::Tests> - Examples of different fennec tools.
