...
require Fennec::Producer;

{
    no strict 'refs';
    no warnings 'redefine';
    my $old = \&{ 'Fennec::Producer::_result' };
    *{ 'Fennec::Producer::_result' } = sub {
...
Fennec::Tester - Make Fennec testable
...
This works by overriding parts of L<Fennec::Producer> so that when called
